          ...
          <TabsList className="container flex flex-col items-center justify-center gap-4 sm:flex-row md:gap-10">
            {tabs.map((tab) => (
              <TabsTrigger
                key={tab.value}
                value={tab.value}
                className="flex items-center gap-2 rounded-xl px-4 py-3 text-sm font-semibold text-muted-foreground data-[state=active]:bg-red-600 data-[state=active]:text-white"
              >
                {tab.icon} {tab.label}
              </TabsTrigger>
            ))}
            ...
            {tabs.map((tab) => (
              ...
              >
                <div className="flex flex-col gap-5">
                  ...
                  <Button className="mt-2.5 w-fit gap-2 bg-red-600 hover:bg-red-700 text-white border-none" size="lg">
