                ...
                <div className="grid items-center gap-12 md:grid-cols-2 md:gap-12 lg:grid-cols-5 lg:gap-24">
                    <div className="lg:col-span-2">
                        <div className="md:pr-6 lg:pr-0">
                            ...
                            <p className="mt-6 text-gray-400">Manage thousands of developers with enterprise-grade controls, security, and compliance built-in.</p>
                        </div>
                        <ul className="mt-8 divide-y divide-white/10 border-y border-white/10 text-white *:flex *:items-center *:gap-3 *:py-3">
                            ...
                            <li>
                                <DraftingCompass className="size-5 text-red-500" />
