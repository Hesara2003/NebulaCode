...
describe('RunService', () => {
    ...
    describe('cancelRun', () => {
        it('should throw ConflictException if run is already in terminal state', async () => {
            ...
            await expect(runService.cancelRun(runId)).rejects.toThrow(ConflictException);
        });
    ...
    describe('getRunStatus', () => {
        it('should throw NotFoundException if run does not exist', async () => {
            ...
            await expect(runService.getRunStatus('nonexistent')).rejects.toThrow(NotFoundException);
        });
